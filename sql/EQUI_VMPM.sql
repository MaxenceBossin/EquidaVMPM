...
--
-- Client :  localhost
-- Généré le :  Mar 21 Mai 2019 à 09:33
...
(6, 'Sole', 0, NULL, 1, 0, NULL, NULL, 1),
(7, 'Davy', 0, NULL, 1, 0, NULL, NULL, 1),
(8, 'Max', 1, '18714950149584FR', 2, 0, NULL, NULL, 1),
(9, 'Balazak', 0, '14576881217278FR', 1, 0, NULL, NULL, 6);
...
(1, 'Course des Rois', '2018-11-21', 'Caen');
...
--
-- Contenu de la table `directeurgeneral`
--
...
(48, 'Testemale', 'tarek', '12 avenue Poursouffle', '14000', 'Tarascon', '', 'FRA', 0, NULL),
(49, 'Trieste', 'Thierry', '1 rue Dieu', '14000', 'Tologne', '', 'FRA', 0, NULL),
(50, 'Jenkins', 'Léa', '4 rue Fleuries', '12114', 'Lhyon', '', 'FRA', 0, NULL);
...
--
ALTER TABLE `cheval`
 ADD PRIMARY KEY (`id`), ADD KEY `FK_CHEVAL_TYPECHEVAL` (`typeCheval`), ADD KEY `mere` (`mere`), ADD KEY `pere` (`pere`), ADD KEY `client` (`client`);
...
ALTER TABLE `courriel`
 ADD PRIMARY KEY (`id`), ADD KEY `FK_COUR_VENTE` (`vente`);
...
--
-- Index pour la table `directeurgeneral`
--
...
--
ALTER TABLE `enchere`
 ADD PRIMARY KEY (`id`), ADD KEY `lot` (`lot`), ADD KEY `client` (`client`);

--
-- Index pour la table `joint`
--
ALTER TABLE `joint`
 ADD PRIMARY KEY (`courriel`,`pieceJointe`), ADD KEY `FK_JOINT_PIECE` (`pieceJointe`);
...
--
ALTER TABLE `lot`
 ADD PRIMARY KEY (`id`), ADD KEY `FK_LOT_CHEVAL` (`idCheval`), ADD KEY `FK_LOT_VENTE` (`idVente`);

--
-- Index pour la table `participer`
--
ALTER TABLE `participer`
 ADD PRIMARY KEY (`idCheval`,`idCourse`), ADD KEY `idCourse` (`idCourse`);
...
ALTER TABLE `utilisateur`
 ADD PRIMARY KEY (`id`), ADD KEY `FK_cli_pays` (`codePays`), ADD KEY `compte` (`compte`);

--
-- Index pour la table `vente`
--
ALTER TABLE `vente`
 ADD PRIMARY KEY (`id`), ADD KEY `codeCategVente` (`codeCategVente`), ADD KEY `FK_VENTE_LIEU` (`lieu`);
